    ...
    <div class="payment">
        <div class="tatacara h-75 w-100">
            <div class="peserta">
                ...
                <p class="pt-2">Selamat Datang di pembayaran tiket seminar CampEvent . Berikut tata cara pembayaran tiket
                    seminar :</p>
                <p class="pt-2">1. Isi data diri yang tertera pada form di bawah ini</p>
                <p class="pt-2">2. Upload bukti pembayaran berupa screenshoot gambar bukti transfer atau bukti pembayaran
                    lainnya</p>
        ...
        <div class="pembayaran">
            <form action="/payment" method="post" class="card-form pt-5" enctype="multipart/form-data">
                ...
                <div class="form-login mb-4">
                    ...
                    <input type="hidden" class="form-control @error('event_title') is-invalid @enderror" name="event_price"
                        id="price" value="{{ $event->price }}">
                ...
                <div class="mb-4 text-center col mb-5">
                    <button class="btn btn-1 tombol rounded" data-bs-toggle="modal"
