                        ...
                        <div class="col-sm-6">
                            <div class="form-name">
                                ...
                                <input type="text" class="form-control @error('firstname') is-invalid @enderror"
                                    name="firstname" id="#" placeholder="Enter your first name">
                                @error('firstname')
                        ...
                        <div class="col-sm-6" style="padding-left: 25px;">
                            <div class="form-name">
                                ...
                                <input type="text" class="form-control @error('lastname') is-invalid @enderror"
                                    name="lastname" id="#" placeholder="Enter your last name">
                                @error('lastname')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-sm-6" style="padding-left: 25px;">
                            <div class="form-number">
                                ...
                                <input type="number" class="form-control @error('no_hp') is-invalid @enderror"
                                    name="no_hp" id="#" placeholder="Enter your phone number">
                                @error('message')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="row" style="padding-top: 40px;">
                        <div class="col-sm-12">
                            <div class="form-question">
                                ...
                                <textarea type="text" class="fc-q form-control @error('message') is-invalid @enderror" name="message" id="#"
